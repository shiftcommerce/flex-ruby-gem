...
describe "Server Asset Folders Spec", :server do
  def test_class
    FlexCommerce::AssetFolder
  end
  ...
  context "full CRUD" do
    ...
    before(:context) do
      setup_for_api!
      created_resource = test_class.create attributes_for(:asset_folder)
    ...
    context "read" do
      context "#all" do
        let(:found_resources) { test_class.page(1).per(50) }
