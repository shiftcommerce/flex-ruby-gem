...
RSpec.describe Payments::PaymentProcess::Middleware::ShippingAddressVerification do
  ...
  context "#call", account: true do
    context "happy path" do
      ...
      let(:cart) { create(:cart, :with_line_items, line_items_count: 2, shipping_address: address) }
      let(:transaction) { create(:payment_transaction, container: cart) }
